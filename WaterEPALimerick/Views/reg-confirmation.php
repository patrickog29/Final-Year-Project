...
<?php
            /* This page reg-confrimation.php indicates a successfull sign up(validated)*/
session_start();
...
<nav class="navbar navbar-light navbar-expand-md" style="background-color:#0091EA;">
 ...
 <!--####################################################################################################################################--->                                                
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active">Email Confirmation</h2>

          
          <p>
          <?php 
     
          // Display mesage about account verification link only once
