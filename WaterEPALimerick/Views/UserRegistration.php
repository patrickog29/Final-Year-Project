...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <!-- Function call set for Activate/Diactivate Status -->
    
        <script type="text/javascript">
function user_disactive_user(val, id){
...
<div class="table-responsive" id="myTable">
    <table class="table table">
        ...
        <tr>
            ...
            <td>
             <select onchange="user_disactive_user(this.value,<?php echo $row['id'];?>)">
