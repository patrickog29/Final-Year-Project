...
<?php include('Navigations-Footers/Admin-Navigation.php'); ?>
 ...
 <!--######################################################################################################################--->
           ...
           <div class="card-body">                                     
                                                  ...
                                                  <section>
           <div>     
               <a href="waterbodySearch.php" class="btn btn-default">Back</a>
                 

          <h4>Final Water Quality Status:&nbsp;<span class="status"><?php echo $post['q']; ?></span></h4>
          ...
          <table class="table">
           ...
           <tbody>
               ...
               <tr>
                   <td>Nitrite</td>
                   <td>0.05 mg/L</td>
                   <td><?php echo $post['nitrate'];?></td>
               </tr>
               <tr>
                   <td>Suspended Solids (SS)</td>
                   <td>50 mg/L</td>
                   <td><?php echo $post['SS'];?></td>
               </tr>
               <tr>
                   <td>Alkalinity</td>
                   <td>No Limit</td>
                   <td><?php echo $post['alkalinity'];?></td>
               </tr>
               <tr>
                   <td>Biochemical Oxygen Demand(BOD)</td>
                   <td>5 mg/L</td>
                   <td><?php echo $post['BOD'];?></td>
               </tr>
               <tr>
                   <td>Ammonia</td>
                   <td>1.5 mg/L</td>
                   <td><?php echo $post['NH3'];?></td>
               </tr>
               <tr>
                   <td>phosphate</td>
                   <td>0.7 mg/L</td>
                   <td><?php echo $post['phosphate'];?></td>
               </tr>
           </tbody>
          </table>
